...
display_info() {
    ...
    echo "                                                             "
    echo "  🌐 Web Application:    http://$IP:18080"
    echo "  🗄️ phpMyAdmin:         http://$IP:18081"
...
main() {
    ...
    echo -e "╔════════════════════════════════════════════════════════════╗"
    echo -e "║         🚀 PnuSeat Multi-Platform Setup Script 🚀          ║"
    echo -e "║                                                            ║"
    echo -e "║   Supports: Linux, macOS, Windows (WSL/Git Bash)           ║"
    echo -e "╚════════════════════════════════════════════════════════════╝"
    echo ""
    detect_os
    check_privileges
